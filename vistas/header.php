  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="propuestas.php"><span class="fa-regular fa-folder-open"></span>   Propuestas</a>  <!--<i class="fa-solid fa-folder-open" ></i> -->
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Proyectos.php"><span class="fa-solid fa-folder-open" ></span>  Proyectos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" data-bs-toggle="modal" data-bs-target="#exampleModal"><span class="fa-solid fa-book" ></span>   Postulaciones A.P</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Programas.php"><span class="fa-solid fa-address-book"></span>   Ciclos </a> 
        </li>
        <li class="nav-item">
          <a class="nav-link" href="jurado.php"><span class="fa-solid fa-gavel" ></span>  Jurado </a> 
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Docentes.php"><span class="fa-solid fa-user-tie"></span>   Administrativo</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Registrodocente.php"><span class="fa-solid fa-user-plus"></span>  Nuevousuario </a>  
        </li>
        <li class="nav-item">
          <a class="nav-link" href="Estudiantes.php"><span class="fa-solid fa-id-card"></span>   Estudiantes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="#"><span class="fa-regular fa-calendar"></span>   Fechas</a>
        </li>
        <li class="nav-item">
