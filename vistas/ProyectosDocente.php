...
?>
    ...
    <div class="container">
        ...
        <div id="TabalaProyestosDocnete"></div>  <!-- -->
    </div>
    </div>
...
<div class="modal fade" id="ModalAsignarCorreciones" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<script type="text/javascript">
    ...
    {
        $('#TabalaProyestosDocnete').load("proyectos/TproyectosDocente.php");
    });
