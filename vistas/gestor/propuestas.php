...
<div class="modal fade" id="VisaulisarPropuesta" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#ModalDirector">
                ...
                <button class="btn btn-danger"onclick="VisualisarDocumentoPropuestas()" target="_blank">Propuesta</button>
...
<script type="text/javascript">
    ...
    $('#ModalDirector').on('shown.bs.modal', function() {
